"""SkillGeneratorAgent — Gera novas skills automaticamente a partir da base de conhecimento.

Analisa entries na KB, identifica padrões recorrentes e propõe
novas skills que são registradas no DynamicSkillRegistry.
"""
...
from iaglobal.evolution.skills.run_fn_factory import (
    make_dynamic_run_fn, TEMPLATE_REGISTRY
)
