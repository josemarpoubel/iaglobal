...
class AgentMessage:
    ...
    priority: int = (
        1  # Aceita explicitamente o parâmetro de prioridade dos nós de grafos
    )
...
class AcetylcholineBus:
    ...
    @instrument(name="acetylcholine_bus.emit")
    ...
    async def _execute_callback(
        self, callback: Callable[[AgentMessage], Any], message: AgentMessage
    ):
        try:
