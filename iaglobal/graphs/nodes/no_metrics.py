    ...
    try:
        ...
        return {
            ...
            "execution_metrics": {
                ...
                "success": True,
                "latency": latency_ms,
                "cost": ctx.get("estimated_cost", 0.002)  # Análise local leve, mas consome processamento
            }
        }

    except Exception as e:
        latency_ms = (time.time() - start_time) * 1000.0
        logger.exception("[METRICS] Falha crítica durante a execução da auditoria: %s", e)
