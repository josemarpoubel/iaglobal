...
async def run_skill_generator(ctx: Dict[str, Any]) -> Dict[str, Any]:
    ...
    logger.info(
        "[SKILL_GENERATOR] Iniciando varredura e meta-geração de novas skills..."
    )
    ...
    try:
        ...
        logger.info(
            "[SKILL_GENERATOR] Sucesso! %d novas skills mutadas e geradas", count
        )
        ...
        return {
            ...
            "execution_metrics": {
                ...
                "cost": ctx.get(
                    "estimated_cost", 0.02
                ),  # Geração de código consome mais tokens
            },
        }
        ...
        latency_ms = (time.time() - start_time) * 1000.0
        logger.exception(
            "[SKILL_GENERATOR] Falha crítica durante a geração de skills: %s", e
        )
        ...
        return {
            ...
            "execution_metrics": {
                ...
                ),  # Custo computado até o momento do crash
            },
        }
