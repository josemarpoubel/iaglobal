...
class WebBrain:
    ...
    def search(self, query: str, max_results: int = 5) -> List[Dict]:
        ...
        self._cache[cache_key] = {"results": ranked, "ts": datetime.now(timezone.utc)}
        return ranked
    ...
    def _wikipedia(self, query: str, max_results: int) -> List[Dict]:
        ...
        try:
            ...
            if (
                ...
                logger.warning(
                    f"[WEB-BRAIN] Hostname potencialmente inseguro: {parsed.hostname}"
                )
                return []
            ...
            "python": [
                {
                    ...
                    "content": "New features in Python 3.13 include free-threaded mode and JIT compiler improvements.",
                },
                {
                    "title": "Django 5.1 Update",
                    "content": "Django 5.1 brings new model constraints and async improvements.",
                },
            ],
            "ai": [
                {
                    "title": "OpenAI GPT-5 Announced",
                    "content": "OpenAI announced GPT-5 with improved reasoning and multimodal capabilities.",
                },
                {
                    "title": "Meta Releases Llama 4",
                    "content": "Meta's Llama 4 is a open-source model with 400B parameters.",
                },
            ],
            "machine learning": [
                {
                    "title": "Scikit-learn 1.6",
                    "content": "New release includes improved transformers and better performance.",
                },
            ],
        }
