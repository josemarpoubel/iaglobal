...
class GenesisHandshake:
    ...
    def build_server_hello(self, client_hello: Dict[str, str], secret: str, max_age: float = 60.0) -> Dict[str, str]:
    ...
    def build_verify_cross(self, server_hello: Dict[str, str], secret: str, max_age: float = 60.0) -> Dict[str, str]:
