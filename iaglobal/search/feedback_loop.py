...
class FeedbackLoop:
    ...
    def _load_index(self):
        ...
        try:
            ...
            logger.info(
                ...
                len(self._cache), self._stats["effectiveness_score"]
            )
    ...
    async def record_outcome(
        ...
        logger.info(
            ...
            query[:50], outcome.value, agent_id,
            confidence_before or 0, confidence_after or 0
        )
    ...
    async def update_confidence(
        ...
        try:
            ...
            logger.debug(
                ...
                agent_id, confidence, new_confidence,
