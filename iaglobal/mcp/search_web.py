...
class WebSearchTool:
    ...
    async def _try_duckduckgo(self, query: str, max_results: int) -> list[dict[str, Any]]:
        try:
    ...
    async def _try_aiohttp_fallback(self, query: str, max_results: int) -> list[dict[str, Any]]:
        try:
            import aiohttp
