...
class TestConfidenceTracker:
    ...
    def test_record_confidence_updates_cache(self, tracker):
        ...
        tracker.record_confidence("coder", "task_001", confidence=0.85, search_helped=True)
    ...
    def test_get_stats(self, tracker):
        ...
        tracker.record_confidence("coder", "task_001", confidence=0.8, search_helped=True)
        tracker.record_confidence("coder", "task_002", confidence=0.6, search_helped=False)
        tracker.record_confidence("debugger", "task_003", confidence=0.9, search_helped=True)
    ...
    def test_persistence_save_and_load(self, tmp_path):
        ...
        with patch("iaglobal.search.confidence_tracker.JSON_DIR", tmp_path):
            ...
            tracker1.record_confidence("coder", "task_001", confidence=0.85, search_helped=True)
            tracker1._save()
