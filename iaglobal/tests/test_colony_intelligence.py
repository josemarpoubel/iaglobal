...
class TestAgentMessageOrganismID:
    ...
    def test_custom_organism_id(self):
        msg = AgentMessage(sender="alpha", recipient="beta", organism_id="colony-x")
...
class TestColonyQueen:
    ...
    def test_assign_round_robin(self):
        queen = ColonyQueen()
        subtasks = _run(
            queen.decompose({"id": "t", "type": "analysis", "description": "x"})
        )
        workers = ["w1", "w2"]
    ...
    def test_worker_execute_with_latency(self):
        ...
        _run(
            bus.emit(
                AgentMessage(
                    sender="queen",
                    recipient="worker-code",
                    message_type="task_offer",
                    payload={
                        "task_id": "t1",
                        "type": "coder",
                        "description": "escrever função",
                        "parent": "big-task",
                    },
                )
            )
...
class TestColonyIntegrator:
    ...
    def test_integrate_combines_results(self):
        ...
        results = [
            ...
            },
            {
                ...
                "success": True,
                "latency_ms": 200,
                "result": {"output": "código"},
            },
            {
                "task_id": "s3",
                "success": True,
                "latency_ms": 50,
                "result": {"output": "testes"},
            },
        ]
    ...
    def test_format_obsidian_output(self):
        content = ColonyIntegrator._format_obsidian_note(
            "alpha",
            {
                "task_id": "t1",
                "success": True,
...
class TestColonyE2E:
    ...
    def test_three_organisms_end_to_end(self):
        ...
        super_task = {
            "id": "e2e-task",
            "type": "analysis",
            "description": "analisar e reportar",
        }
        ...
        for w in workers:
            ...
            if executed:
                ...
                fitness.record_task(
                    w.organism_id, executed["success"], executed["latency_ms"]
                )
        ...
        fitness.record_task(
            "queen-1", integrated["success"], integrated["total_latency_ms"]
        )
