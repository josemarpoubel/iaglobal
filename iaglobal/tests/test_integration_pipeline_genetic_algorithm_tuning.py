...
from iaglobal.evolution.ga.selector import evolve_population, tournament_select, blend_crossover, gaussian_mutate
from iaglobal.evolution.ga.ga_runner import GARunner, runner, GENOME_PATH, TELEMETRY_PATH
from iaglobal.evolution.epigenetic import get_flag, set_flag, _flags
...
class TestGAEvolutionQuality:
    ...
    def test_population_evolves_across_10_generations(self):
        pop = [Individual(weights=[random.random() for _ in range(4)]) for _ in range(30)]
        for ind in pop:
