...
class TestSearchMemory:
    ...
    @pytest.mark.asyncio
    async def test_save_search_persists_to_disk(self, memory, temp_obsidian, sample_results):
    ...
    @pytest.mark.asyncio
    async def test_save_search_creates_md_file(self, memory, temp_obsidian, sample_results):
    ...
    @pytest.mark.asyncio
    async def test_cleanup_old_searches_removes_md_file(self, memory, temp_obsidian, sample_results):
