...
class TestDebugUnificadoComLSP:
    ...
    async def test_debug_com_erro_sintaxe_lsp(self):
        ...
        assert any(m in metrics['model'] for m in ['skill_debug_unificado', 'debug_unificado'])
    ...
    async def test_debug_fallback_sem_skill(self):
        ...
        with patch('iaglobal.graphs.nodes.no_debug_unificado._tentar_skill') as mock_skill:
...
class TestSkillDebugUnificado:
    ...
    def test_skill_inputs_outputs(self):
        ...
        from iaglobal.evolution.skills.skill_debug_unificado import SkillDebugUnificado
