...
class TestSourceValidator:
    ...
    def test_score_consistency_agreement(self, validator):
        ...
        snippet = {"title": "Python API", "snippet": "Flask is great for building APIs", "url": "url1"}
        all_snippets = [
            snippet,
            {"title": "Flask Tutorial", "snippet": "Flask is awesome for web development", "url": "url2"},
        ]
    ...
    def test_score_consistency_contradiction(self, validator):
        ...
        snippet = {"title": "API", "snippet": "Flask is recommended for production", "url": "url1"}
        all_snippets = [
            snippet,
            {"title": "API", "snippet": "Avoid Flask, don't use it in production", "url": "url2"},
        ]
        score = validator._score_consistency(snippet, all_snippets)
