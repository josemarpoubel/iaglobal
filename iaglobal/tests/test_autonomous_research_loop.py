...
from iaglobal.agents.ingestion.paper_ingestor import PaperIngestor, PaperRecord, RESEARCH_QUEUE_FILE
...
class TestIntegration:
    ...
    async def test_parse_downloaded_paper(self, tmp_path):
        ...
        assert "deep learning" in metadata.title.lower() or "natural language" in metadata.title.lower()
