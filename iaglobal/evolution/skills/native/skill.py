...
# Import do template loader para carregamento automático de prompts
from iaglobal.evolution.skills.utils.template_loader import (
    load_skill_template as _get_template,
)
...
class Skill:
    ...
    # Template para geração LLM (adicionado para evitar cache colision)
    template_type: str = "llm"
    template_prompt: str = ""
...
def _safe_get(context: Dict[str, Any], *keys: str, default: str = "") -> str:
    ...
    for key in keys:
        ...
        if (
            "input" in context
            and isinstance(context["input"], dict)
            and key in context["input"]
        ):
...
SKILL_PLANNER = Skill(
    ...
    tags=["core", "planning"],
    template_type="llm",
    template_prompt=_get_template("planner"),
)
...
SKILL_DOMAIN_ANALYSIS = Skill(
    ...
    tags=["core", "domain"],
    template_type="llm",
    template_prompt=_get_template("domain_analysis"),
)
...
SKILL_BUSINESS_RULES = Skill(
    ...
    tags=["core", "business"],
    template_type="llm",
    template_prompt=_get_template("business_rules"),
)
...
SKILL_TECHNOLOGY_SELECTION = Skill(
    ...
    template_type="llm",
    template_prompt=_get_template("technology_selection"),
)
...
SKILL_SYSTEM_DESIGN = Skill(
    ...
    tags=["core", "design"],
    template_type="llm",
    template_prompt=_get_template("system_design"),
)
...
SKILL_API_DESIGN = Skill(
    ...
    tags=["core", "design"],
    template_type="llm",
    template_prompt=_get_template("api_design"),
)
...
SKILL_CODER = Skill(
    ...
    tags=["core", "coding"],
    template_type="llm",
    template_prompt=_get_template("coder"),
)
...
SKILL_CRITIC = Skill(
    ...
    tags=["core", "review"],
    template_type="llm",
    template_prompt=_get_template("critic"),
)
...
SKILL_INTEGRATOR = Skill(
    ...
    template_type="llm",
    template_prompt=_get_template("integrator"),
)
...
SKILL_FRONTEND_BUILDER = Skill(
    ...
    template_type="llm",
    template_prompt=_get_template("frontend_builder"),
...
SKILL_DATABASE_DESIGN = Skill(
    ...
    tags=["core", "design"],
    template_type="llm",
    template_prompt=_get_template("database_design"),
)
...
SKILL_TEST_GENERATOR = Skill(
    ...
    template_type="llm",
    template_prompt=_get_template("test_generator"),
...
def _get_skill_python_autocomplete():
    from iaglobal.evolution.skills.native.skill_python_autocomplete import (
        skill_python_autocomplete,
    )
