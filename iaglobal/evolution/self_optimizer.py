...
from iaglobal.evolution.skills.utils.dynamic_registry import (
    dynamic_registry,
...
class SelfOptimizingAgentSystem:
    ...
    def refresh_graph_topology(self) -> None:
        ...
        try:
            logger.debug(
                "[SELF-OPTIMIZER] Sincronizando topologia com o catálogo de skills atualizado..."
            )
            ...
            logger.error(
                f"[SELF-OPTIMIZER] Falha ao sincronizar canonicidade do grafo: {e}"
            )
