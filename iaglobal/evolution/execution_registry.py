            ...
            for nid in list(node_ids):
                ...
                if hasattr(nid, 'node_id'):
                    ...
                    if not tribunal.verify_frozen_authority():
                        raise RuntimeError("🚨 [TRIBUNAL] Blueprint violado. Nó não autorizado a ingressar no registry.")
                ...
                if nid not in self._entries[execution_id]:
                    self._entries[execution_id][nid] = self._entries[execution_id][node_name]
