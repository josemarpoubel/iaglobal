...
class TaskAnalyzer:
    ...
    def analyze(cls, prompt: str) -> Dict[str, Any]:
        ...
        logger.debug(
            f"[TASK-ANALYZER] Análise concluída. Estratégias identificadas: {list(strategies)}"
        )
        return {"strategies": strategies, "technologies": technologies}
    ...
    def derive_agents(cls, strategies: Set[str]) -> List[Dict[str, Any]]:
        ...
        from iaglobal.evolution.skills.native.skill import (
            SKILL_CODER,
            SKILL_CRITIC,
            SKILL_SECURITY,
            SKILL_PERFORMANCE,
