    ...
    def _init_table(self):
        ...
        try:
            with conn:
                ...
                """)
                conn.execute(
                    "CREATE INDEX IF NOT EXISTS idx_outcomes_model ON execution_outcomes(model)"
                )
                conn.execute(
                    "CREATE INDEX IF NOT EXISTS idx_outcomes_fingerprint ON execution_outcomes(fingerprint)"
                )
                conn.execute(
                    "CREATE INDEX IF NOT EXISTS idx_outcomes_provider ON execution_outcomes(provider)"
                )
