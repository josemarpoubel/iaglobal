...
class BetaineJudge:
    ...
    @classmethod
    def evaluate(cls, code: str, task: str = "", execution_time: float = 0) -> Dict[str, Any]:
        metrics = {}
        ...
        overall = round((metrics["syntax_score"] * 0.3 + metrics["performance_score"] * 0.2 + metrics["llm_score"] * 0.5), 2)
