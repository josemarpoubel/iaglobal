...
class ComplianceChecker:
    ...
    def __init__(self):
        self.DANGEROUS_IMPORTS = [
            "pickle", "marshal", "shelve",  # Serialização insegura
            "telnetlib", "ftplib",  # Protocolos inseguros
        ]
    ...
    def full_audit(self, codigo: str, imports: List[str], threshold: float = 0.5) -> Dict[str, Any]:
        """
    ...
    def check_import_safety(self, import_statement: str) -> bool:
        ...
        """
        imp_name = import_statement.split()[0].split('.')[-1] if import_statement else ""
