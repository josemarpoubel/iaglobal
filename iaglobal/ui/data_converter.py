        ...
        try:
            ...
            if data:
                ...
                execution = {
                    ...
                    "datetime": datetime.fromtimestamp(file_path.stat().st_mtime).isoformat(),
                    "data": json_data,
...
def get_metabolic_state() -> Dict:
    ...
    pool_files = list(MEMORY_DIR.glob("**/*pool*.cbor")) + \
                 list(MEMORY_DIR.glob("**/*pool*.json"))
    ...
    energy_files = list(MEMORY_DIR.glob("**/*atp*.cbor")) + \
...
def get_epigenetic_markers(agent_id: Optional[str] = None) -> Dict:
    ...
    epi_files = list(MEMORY_DIR.glob("**/epigenetic/**/*.cbor")) + \
