...
def AgentCard(agent_name: str, status: str = "idle", metrics: Optional[Dict] = None):
    ...
    return html.div(
        ...
        html.h3(
            {"style": {"color": DARK_THEME["accent"], "marginBottom": "0.5rem"}},
            agent_name,
        ),
        html.span(
            {
...
def MetricsDashboard(agents: Optional[List[Dict]] = None):
    ...
    return html.div(
        ...
        html.h1(
            {"style": {"color": DARK_THEME["accent"], "marginBottom": "1rem"}},
        ...
        html.div(
            ...
            *[AgentCard(**agent) for agent in agents_list]
            if agents_list
            else [
...
def RestaurantProductCard(name: str, price: str, category: str = "dishes"):
    ...
    return html.div(
        ...
        html.h3(
            {"style": {"color": DARK_THEME["text_light"], "marginBottom": "0.25rem"}},
            name,
        ),
        html.p(
            {
...
def RestaurantMenuPage():
    ...
    return html.div(
        ...
        html.header(
            ...
            html.h1(
                {"style": {"color": DARK_THEME["accent"]}}, "Restaurante Sabor do Dia"
            ),
        ),
        html.main(
            ...
            html.section(
                {},
                html.h2(
                    {"style": {"color": DARK_THEME["text_light"]}}, "Pratos do Dia"
                ),
            ...
            html.section(
                {},
                html.h2(
                    {"style": {"color": DARK_THEME["text_light"], "marginTop": "2rem"}},
                    "Bebidas",
                ),
...
def EntropyDashboard():
    ...
    if loading:
        return html.div(
            {"style": {"color": DARK_THEME["text_light"], "padding": "2rem"}},
            "Carregando entropia...",
        )

    if "error" in data:
        return html.div(
            {"style": {"color": DARK_THEME["accent_red"], "padding": "2rem"}},
            f"Erro: {data['error']}",
        )
    ...
    return html.div(
        ...
        html.div(
            ...
            html.div(
                ...
                html.div(
                    {"style": {"fontSize": "0.85rem", "color": DARK_THEME["text_dim"]}},
                    "Total Perfis",
                ),
                html.div(
                    {"style": {"fontSize": "2rem", "fontWeight": "bold"}}, str(total)
                ),
            ),
            html.div(
                {
        ...
        html.div(
            ...
            html.div(
                {"style": {"color": DARK_THEME["text_dim"]}},
