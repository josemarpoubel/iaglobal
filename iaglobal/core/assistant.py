...
from iaglobal.memory.memory import salvar, carregar
...
from iaglobal.reflection.reflexion_engine import reflexion_loop
...
class Assistant:
    def __init__(self, web_enabled: bool = True, kb_learning: bool = True,
        ...
        self.stm = ShortTermMemory(max_size=50, ttl_seconds=1800)
        self.ltm = LongTermMemory(max_size=500)
        ...
        self.skill_gen = SkillGeneratorAgent() if skill_generation else None
