...
class AnalisadorRotas:
    ...
    def diagnosticar(provedor: str, modelo: str, erro: Exception) -> dict:
        ...
        if (
            "429" in erro_str
            or "quotaed" in erro_str
            or "exceeded" in erro_str
            or "rate_limit" in erro_str
        ):
        ...
        # 2. Identificação de Chave de API Inválida (HTTP 401 / Autenticação)
            ...
            "401" in erro_str
            or "invalid" in erro_str
            or "unauthorized" in erro_str
            or "api key" in erro_str
        ):
        ...
        # 3. Identificação de Erro de Modelo Inexistente (HTTP 404 / Not Found)
            ...
            "404" in erro_str or "not found" in erro_str or "unknown model" in erro_str
        ):
        ...
        # 4. Identificação de Timeout ou Rede Offline
            ...
            "timeout" in erro_str
            or "connection timed out" in erro_str
            or "read timeout" in erro_str
        ):
