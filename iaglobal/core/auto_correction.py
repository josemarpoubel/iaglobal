...
class AutoCorrectionLoop:
    ...
    def corrigir(self, codigo: str, task: str = "") -> Correcao:
        ...
        for i in range(self.MAX_ITERATIONS):
            ...
            if issues:
                ...
                logger.info(
                    ...
                    i + 1, self.MAX_ITERATIONS, len(issues), len(fixes), linguagem,
                )
        ...
        if foi_corrigido:
            logger.info(
                ...
                len(issues_encontradas), len(fixes_aplicados), linguagem, latency,
            )
        else:
            logger.info(
    ...
    def _validar_js(self, codigo: str, lang: str) -> Tuple[List[str], List[str]]:
        ...
        try:
            import esprima
            source_type = "module" if "import " in codigo or "export " in codigo else "script"
    ...
    def _fechar_brackets(self, codigo: str) -> str:
        ...
        try:
            from iaglobal.validation.js_validator import _close_unclosed_brackets as _js_close
