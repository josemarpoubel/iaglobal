...
def generate(
    prompt: str,
    model: str = "opencode/nemotron-3-super-free",
    timeout: int = 60,
...
async def async_generate(prompt: str, model: str = "opencode/nemotron-3-super-free", timeout: int = 60, token_collector: Optional[TokenCollector] = None) -> str:
