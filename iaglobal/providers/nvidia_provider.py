...
def generate(prompt: str, model: str = "nvidia/mistralai/mistral-large-3-675b-instruct-2512", timeout: int = 60, token_collector: Optional[TokenCollector] = None) -> str:
...
async def async_generate(prompt: str, model: str = "nvidia/mistralai/mistral-large-3-675b-instruct-2512", timeout: int = 60, token_collector: Optional[TokenCollector] = None) -> str:
    ...
    return await async_post(url, payload, headers=headers, timeout=timeout, token_collector=token_collector)
