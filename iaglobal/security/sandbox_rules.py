...
class SandboxRules:
    ...
    DEFAULT_ALLOWED_MODULES: Set[str] = {
        ...
        "selenium", "playwright",
        "yfinance", "investpy", "alpha_vantage",
        "dotenv",
        "fpdf", "fpdf2",
    ...
    def _auto_discover_installed_packages(self):
        ...
        try:
            ...
            pkgs = [dist.metadata.get("Name", "").lower() for dist in md.distributions()]
            ...
            for alias in ["bs4", "yfinance", "sklearn", "cv2", "PIL"]:
                try:
                    ...
                    pass
            logger.info("[SANDBOX-RULES] Auto-descobertos %d pacotes instalados", len(pkgs))
