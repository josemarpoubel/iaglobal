...
async def _publish_apoptosis_event(agent_name: str, entropy_result: Dict[str, Any]) -> None:
    ...
    try:
        ...
        logger.warning(
            ...
            agent_name, entropy_result.get("entropy_score", 0), entropy_result.get("trend", "unknown"),
        )
    except Exception as e:
        logger.debug("[ENTROPY_INTERCEPTOR] Falha ao publicar apoptose: %s", e)


async def _publish_degradation_alert(agent_name: str, entropy_result: Dict[str, Any]) -> None:
